...
后端工作区使用 Rust 2024 edition、最低 Rust `1.90`，HTTP 服务为 `warp 0.4.3`，异步运行时 `tokio 1.53`，上游客户端 `reqwest 0.13`，存储为 `sqlx 0.9` + SQLite。前端使用 Vue 3.6 RC Vapor、Vite+ `0.2.8`、Vite 8、Tailwind 4、Reka UI 2 和 Liquid Glass Vue 1。
